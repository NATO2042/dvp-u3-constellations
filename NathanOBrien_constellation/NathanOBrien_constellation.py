...
plt.annotate(
    ...
    xy=(0.01, 9.1), arrowprops=dict(arrowstyle='->'), xytext=(0.1, 9.5))

plt.title("Tears in the Rain 2d", fontweight='heavy')
plt.xlabel('δ')
plt.ylabel('α')
plt.show()
plt.savefig('C-Beams 2d.png')
...
constellation3d = plt.scatter(x, y, z, color='blue', marker='8')

plt.title("Tears in the Rain 3d", fontweight='heavy', color='blue')

plt.show()
plt.savefig('C-Beams 3d.png')
